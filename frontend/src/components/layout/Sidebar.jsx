  ...
  const { portalName, basePath, navItems } = useMemo(() => {
    ...
    if (role === 'admin' || role === 'super_admin') {
      ...
      config.navItems = [
        ...
        { icon: '👥', label: 'Manage Alumni', path: '/admin/alumni' },
      ];
      if (isSuperAdmin) {
      ...
      config.basePath = '/student'; // You can change this to '/u' if you prefer
      config.navItems = [
        ...
        { icon: '📄', label: 'Applications', path: `${config.basePath}/applications` },
