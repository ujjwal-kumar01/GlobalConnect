...
const OnboardingStudent = () => {
  ...
  // Generate an array of years for the dropdown (from current year + 6 back to 1980)
  const currentYear = new Date().getFullYear();
  const years = Array.from({ length: currentYear + 6 - 1980 }, (_, i) => currentYear + 5 - i);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Use replace: true so they can't hit the back button into the onboarding flow
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              <input
                type="text"
                placeholder="Search your alma mater..."
                autoComplete="off"
                {...register("college", { required: "Please select your institution." })}
                onFocus={() => setShowDropdown(true)}
                onChange={(e) => {
                  register("college").onChange(e); // Trigger RHF's internal onChange
            ...
            {errors.college ? (
              <p className="text-[10px] font-bold text-red-500 ml-1 mt-1">{errors.college.message}</p>
            ) : (
              <p className="text-[10px] text-slate-400 ml-1 mt-1">Type to search from 5,000+ global institutions</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="e.g. Senior Architect (or 'Student')"
                {...register("position")}
