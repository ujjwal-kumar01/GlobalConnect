...
const Sidebar = () => {
  ...
  const navItems = [
    { icon: '🎛️', label: 'Dashboard', path: '/u/dashboard' },
    { icon: '👥', label: 'Alumni', path: '/u/alumni' },
    { icon: '💬', label: 'Messages', path: '/u/messages' },
    { icon: '💼', label: 'Jobs', path: '/u/jobs' },
    { icon: '📄', label: 'Applications', path: '/u/applications' },
    { icon: '📈', label: 'Activity', path: '/u/activity' },
    { icon: '🔔', label: 'Notifications', path: '/u/notifications' },
  ];
